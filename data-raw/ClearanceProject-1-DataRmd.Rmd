...
all_chems <- member_list$httk_3comp2

# save in an .Rdata file
save(target_chems, all_chems,
...
chem_info %>% distinct(dtxsid, preferredName,
  ...
  saveRDS(file = "data-raw/ctxR_3comp2_cheminfo.rds")
...
this_clint_df <- data.frame(Chemical = names(this_param_rest_l),
...
save(this_param_rest_l, this_param_nrest_l,
     this_param_df, this_httk_clearance_df,
     all_httk_preds, this_css_df, this_clint_df,
