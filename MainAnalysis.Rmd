...
write.csv(PK.fit.table.1comp, paste("inst/ext/PK_fit_table_1comp_",THIS.DATE,".csv",sep=""), row.names = FALSE)
...
write.csv(PK.fit.table.2comp, paste("inst/ext/PK_fit_table_2comp.",THIS.DATE,".csv",sep=""), row.names = FALSE)
