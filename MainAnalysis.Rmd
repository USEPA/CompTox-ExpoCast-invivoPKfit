...
```
```{r, plot_2comp, eval=FALSE}
plot_conctime(PK.fit.table.2comp[[1]],cvt.data,"2compartment")
head(subset(PK.fit.table.2comp[[1]],Vdist>10000&!is.infinite(AIC)&param.value.type=="Fitted geometric mean"))
```
...
```{r, write_invivoPKfits_to_file, eval = TRUE}
...
pk_output_2comp <- read.csv(paste("inst/ext/PK.fit.table.2comp.",THIS.DATE,".csv",sep=""))
pk_output_flat <- read.csv(paste("inst/ext/PK.fit.table.flat.",THIS.DATE,".csv",sep=""))
pk_output_1comp <- read.csv(paste("inst/ext/PK.fit.table.1comp.",THIS.DATE,".csv",sep=""))

raw_1comp <- read.csv(paste("inst/ext/processed.1comp.data.",THIS.DATE,".csv",sep=""))
raw_2comp <- read.csv(paste("inst/ext/processed.2comp.data.",THIS.DATE,".csv",sep=""))
raw_flat <- read.csv(paste("inst/ext/processed.flat.data.",THIS.DATE,".csv",sep=""))
