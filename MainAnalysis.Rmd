...
### this block runs the model fits
# and does some pre-processing to clean up the data
...
cvt.data <- read.csv("inst/ext/cvtdb_invivopkfit_04262022.csv")

### these compounds had no CAS in the cvtdb
# double check and they should not have been added
# so I removed them
...
### fix compound names
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "Methyleugonal "] <- "Methyleugonal"
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "benzo[a]pyrene"] <- "benzo(a)pyrene"
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "2,4-D"] <- "2,4-Dichlorophenoxyacetic acid"
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "Diclofenac"] <- "Hexobarbital"
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "Pentadecafluorooctanoic acid"] <- "Perfluorooctanoic acid"
cvt.data$analyte_name_original[cvt.data$analyte_name_original == "3−hydroxybenzo[a]pyrene"] <- "3−hydroxybenzo(a)pyrene"

### make fk_reference_document equal fk_extraction document if fk_reference_document is NULL
cvt.data$fk_reference_document_id[cvt.data$fk_reference_document_id == "NULL"] <- 
  cvt.data$fk_extraction_document_id[cvt.data$fk_reference_document_id == "NULL"]

### this is basically my debug line,
# where I can focus on one problematic compound 
# and see what's going wrong
# data <- data %>% filter(dsstox_casrn == "68291-97-4" | dsstox_casrn == "82626-48-0")
# data <- data %>% filter(dsstox_casrn == "123-91-1")
```
...
for (this.study in unique(cvt.data[,source.col]))
{
  ...
  for (this.chem in unique(this.subset1[,cas.col]))
  {
    this.subset2 <- subset(this.subset1,this.subset1[,cas.col]==this.chem)
    for (this.media in unique(this.subset2[,media.col]))
    {
      ...
      cvt.data[
        ...
        cvt.data[,cas.col]==this.chem & 
        cvt.data[,media.col]==this.media,"calc_loq"] <- this.loq
    }
  }
}
...
```{r, run_invivoPKfit_1comp, eval = TRUE}
THIS.DATE <- "102422"
...
```{r, plot_1comp, eval=TRUE}
plot_conctime(PK.fit.table.1comp[[1]],cvt.data,"1compartment")
head(subset(PK.fit.table.1comp[[1]],Vdist>10000&!is.infinite(AIC)&param.value.type=="Fitted geometric mean"))
```

```{r, run_invivoPKfit_2comp, eval = TRUE}
...
```{r, run_invivoPKfit_flat, eval = TRUE}
### do flat fit
...
### uncomment below to export to CSV files
# change the date!!

write.csv(PK.fit.table.1comp[[1]], paste("inst/ext/PK.fit.table.1comp.",THIS.DATE,".csv",sep=""), row.names = FALSE)
write.csv(PK.fit.table.1comp[[2]], paste("inst/ext/processed.1comp.data.",THIS.DATE,".csv",sep=""), row.names = FALSE)

write.csv(PK.fit.table.2comp[[1]], paste("inst/ext/PK.fit.table.2comp.",THIS.DATE,".csv",sep=""), row.names = FALSE)
write.csv(PK.fit.table.2comp[[2]], paste("inst/ext/processed.2comp.data.",THIS.DATE,".csv",sep=""), row.names = FALSE)

write.csv(PK.fit.table.flat[[1]], paste("inst/ext/PK.fit.table.flat.",THIS.DATE,".csv",sep=""), row.names = FALSE)
write.csv(PK.fit.table.flat[[2]], paste("inst/ext/processed.flat.data.",THIS.DATE,".csv",sep=""), row.names = FALSE)
```
...
# save(pk_output_1comp_04142022, file = "figures_rdata/pk_output_1comp_04142022.Rdata")
# save(pk_output_2comp_04142022, file = "figures_rdata/pk_output_2comp_04142022.Rdata")
# save(pk_output_flat_04142022, file = "figures_rdata/pk_output_flat_04142022.Rdata")
# save(raw_1comp_04142022, file = "figures_rdata/raw_1comp_04142022.Rdata")
# save(raw_2comp_04142022, file = "figures_rdata/raw_2comp_04142022.Rdata")
# save(raw_flat_04142022, file = "figures_rdata/raw_flat_04142022.Rdata")

save(pk_output_1comp_05092022, file = "figures_rdata/pk_output_1comp_05092022.Rdata")
save(pk_output_2comp_05092022, file = "figures_rdata/pk_output_2comp_05092022.Rdata")
save(pk_output_flat_05092022, file = "figures_rdata/pk_output_flat_05092022.Rdata")
save(raw_1comp_05092022, file = "figures_rdata/raw_1comp_05092022.Rdata")
save(raw_2comp_05092022, file = "figures_rdata/raw_2comp_05092022.Rdata")
save(raw_flat_05092022, file = "figures_rdata/raw_flat_05092022.Rdata")
...
# load("figures_rdata/pk_output_1comp_04142022.Rdata")
# load("figures_rdata/pk_output_2comp_04142022.Rdata")
# load("figures_rdata/pk_output_flat_04142022.Rdata")
# load("figures_rdata/raw_1comp_04142022.Rdata")
# load("figures_rdata/raw_2comp_04142022.Rdata")
# load("figures_rdata/raw_flat_04142022.Rdata")
# load("figures_rdata/cp_df_04142022.Rdata")
# load("figures_rdata/cvt_variability_df_04142022.Rdata")
# 
# load("figures_rdata/cp_df_03302022.Rdata")

# load("figures_rdata/pk_output_1comp_04282022.Rdata")
# load("figures_rdata/pk_output_2comp_04282022.Rdata")
# load("figures_rdata/pk_output_flat_04282022.Rdata")
# load("figures_rdata/raw_1comp_04282022.Rdata")
# load("figures_rdata/raw_2comp_04282022.Rdata")
# load("figures_rdata/raw_flat_04282022.Rdata")
# load("figures_rdata/cp_df_04282022.Rdata")
# load("figures_rdata/cvt_variability_df_04282022.Rdata")
# 
# load("figures_rdata/cp_df_04282022.Rdata")

load("figures_rdata/pk_output_1comp_05092022.Rdata")
load("figures_rdata/pk_output_2comp_05092022.Rdata")
load("figures_rdata/pk_output_flat_05092022.Rdata")
load("figures_rdata/raw_1comp_05092022.Rdata")
load("figures_rdata/raw_2comp_05092022.Rdata")
load("figures_rdata/raw_flat_05092022.Rdata")
load("figures_rdata/cp_df_05092022.Rdata")
load("figures_rdata/cvt_variability_df_05092022.Rdata")
...
junk <- plot_conctime(PK.fit.table = as.data.table(pk_output_1comp_05092022),
                      data.set = as.data.table(raw_1comp_05092022),
                      model = "1compartment")

### 2 compartment
junk <- plot_conctime(PK.fit.table = as.data.table(pk_output_2comp_05092022),
                      data.set = as.data.table(raw_2comp_05092022),
                      model = "2compartment")

junk <- plot_conctime(PK.fit.table = as.data.table(pk_output_flat_05092022),
                      data.set = as.data.table(raw_flat_05092022),
                      model = "flat")
...
raw_data1 <- dplyr::select(raw_1comp_05092022, -c("kelim", 
                                                  "Vdist", 
                                                  "Fgutabs", 
                                                  "kgutabs")) %>% 
  filter(Species != "hamster")
...
### subset to only actual model outputs and discard "Joint Analysis" rows
pk_data2 <- pk_output_2comp_05092022 %>%
  filter(param.value.type == "Fitted geometric mean" & Data.Analyzed != "Joint Analysis")

raw_data2 <- dplyr::select(raw_2comp_05092022, -c("kelim", 
                                                  "Vdist", 
                                                  "Fgutabs", 
                                                  "kgutabs",
                                                  "V1",
...
pk_data_flat <- pk_output_flat_05092022 %>%
  filter(param.value.type == "Fitted geometric mean" & Data.Analyzed != "Joint Analysis") %>% 
  filter(Species != "hamster")

raw_data_flat <- dplyr::select(raw_flat_05092022, -c("A")) %>% 
  filter(Species != "hamster")
...
cp_df_05092022 <- cp_df

### here is where you save the Rdata file
save(cp_df_05092022, file = "figures_rdata/cp_df_05092022.Rdata")
```
...
data <- as.data.table(raw_1comp_05092022)
...
cvt_variability_df_05092022 <- do.call(rbind, data.list)

### SAVE the data
save(cvt_variability_df_05092022, file = "figures_rdata/cvt_variability_df_05092022.Rdata")
```
...
data <- cvt_variability_df_05092022
...
cvt_data <- cvt_variability_df_05092022
...
data1 <- as.data.table(pk_output_1comp_04282022 %>%
                         filter(param.value.type == "Fitted geometric mean"))

data2 <- as.data.table(pk_output_2comp_04282022 %>%
                         filter(param.value.type == "Fitted geometric mean"))
...
raw_data2 <- raw_2comp_04282022

pk_data2 <- pk_output_2comp_04282022 %>% 
  filter(param.value.type == "Fitted geometric mean" & Data.Analyzed != "Joint Analysis")
...
pk_data1 <- as.data.table(pk_output_1comp_04282022)
pk_data2 <- as.data.table(pk_output_2comp_04282022)
...
pk_data_flat <- pk_output_flat_04282022 %>%
