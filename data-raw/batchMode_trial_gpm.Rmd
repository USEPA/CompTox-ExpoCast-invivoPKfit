...
my_predata <- cvt %>%
  dplyr::filter(chemicals_analyzed.dsstox_substance_id %in% "DTXSID8025337")

my_predata <- cvt %>%
  dplyr::filter(chemicals_analyzed.dsstox_substance_id %in% "DTXSID9022360")

# Reasonable fits... multiple species
my_predata <- cvt %>%
...
my_predata <- cvt %>%
  dplyr::filter(chemicals_analyzed.dsstox_substance_id %in% c("DTXSID1043881",
                                                              "DTXSID8020541",
                                                              "DTXSID6034849"),
...
my_predata <- cvt %>%
  dplyr::filter(chemicals_analyzed.dsstox_substance_id %in% c("DTXSID1034187",
                                                              "DTXSID2021315",
                                                              "DTXSID3032179",
                                                              "DTXSID4020533"))
...
{
  start_t <- Sys.time()
  normal_fit <- do_fit(my_pk)
  round(Sys.time() - start_t, 3) # 5.741min (5 data_groups)
} 
# Timing for multidplyr
{
  start_t <- Sys.time()
  party_fit <- do_fit(my_pk)
  round(Sys.time() - start_t, 3) # 2.514min (5 data_groups)
}
my_pk <- do_fit(my_pk)

plot(my_pk, method = "L-BFGS-B",
     n_interp = 50) -> pl
...
```{r}
## Do fits
my_pk_000p <- do_fit(my_pk_000p)
my_pk_100p <- do_fit(my_pk_100p)
my_pk_110p <- do_fit(my_pk_110p)
my_pk_111p <- do_fit(my_pk_111p)
my_pk_010p <- do_fit(my_pk_010p)
my_pk_011p <- do_fit(my_pk_011p)
my_pk_001p <- do_fit(my_pk_001p)
my_pk_101p <- do_fit(my_pk_101p)

## Do fits
my_pk_000j <- do_fit(my_pk_000j)
my_pk_100j <- do_fit(my_pk_100j)
my_pk_110j <- do_fit(my_pk_110j)
my_pk_111j <- do_fit(my_pk_111j)
my_pk_010j <- do_fit(my_pk_010j)
my_pk_011j <- do_fit(my_pk_011j)
my_pk_001j <- do_fit(my_pk_001j)
my_pk_101j <- do_fit(my_pk_101j)
```
...
evaluate_choices <- function(obj, PJ = "Pooled") {
  ...
  full_list <- list(winning_model, RMSE_eval, my_df)
  })
...
my_pk_000p <- evaluate_choices(my_pk_000p) # Done
my_pk_100p <- evaluate_choices(my_pk_100p) # Done
my_pk_110p <- do_fit(my_pk_110p) %>% evaluate_choices() # Done
my_pk_111p <- do_fit(my_pk_111p) %>% evaluate_choices() # Done
my_pk_010p <- do_fit(my_pk_010p) %>% evaluate_choices() # Done
my_pk_011p <- do_fit(my_pk_011p) %>% evaluate_choices() # Done (took 1.807 hrs)
my_pk_001p <- do_fit(my_pk_001p) %>% evaluate_choices() # Done

my_pk_101p <- do_data_info(my_pk_101p) # This took 13 min

my_pk_101p <- do_fit(my_pk_101p) %>% evaluate_choices() # Done

my_pk_000j <- do_prefit(my_pk_000j)
my_pk_000j <- do_fit(my_pk_000j) %>% evaluate_choices() # Done (took 16 minutes)
# WOW! A 2-3X speedup from the previous sapply() implementation
my_pk_100j <- do_fit(my_pk_100j) %>% evaluate_choices(PJ = "Joint") 
my_pk_110j <- do_fit(my_pk_110j) %>% evaluate_choices()
my_pk_111j <- do_fit(my_pk_111j) %>% evaluate_choices()
my_pk_010j <- do_fit(my_pk_010j) %>% evaluate_choices()
my_pk_011j <- do_fit(my_pk_011j) %>% evaluate_choices()
my_pk_001j <- do_fit(my_pk_001j) %>% evaluate_choices()
my_pk_101j <- do_fit(my_pk_101j) %>% evaluate_choices()
...
# Run all at once
{
current_pk <- my_pk_000j # Define current evaluated pk object here
