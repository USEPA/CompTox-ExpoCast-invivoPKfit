...
cvt.data <- read.csv("inst/ext/cvtdb_invivopkfit_04262022-2.csv")
...
```{r, set_file_timestamp, eval = TRUE}
THIS.DATE <- "102422"
```

```{r, run_invivoPKfit_1comp, eval = FALSE}
...
system.time(PK.fit.table.1comp <- fit_all(
  ...
  dtxsid.col = "dsstox_substance_id",
  cas.col = "dsstox_casrn",
