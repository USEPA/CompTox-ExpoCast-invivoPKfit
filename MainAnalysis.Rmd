...
Run a one-compartment fit on the data, and write out the results. Timestamp the file name with the current date and time in format YYYY_MM_DD_hh_mm_ss.
...
system.time(
  capture.output(
    ...
    file = paste0("inst/ext/PK_fit_table_1comp_output_",
...
system.time(
  capture.output(
    ...
    file = paste0("inst/ext/PK_fit_table_2comp_output_",
                  format(Sys.time(), "%Y_%m_%d_%H_%M_%S"),
                  ".txt")
  )
)
