...
document, I will take 5% of CVT_Legacy data.
...
From here I need to set up the pk object settings. I will be using the dose-normalization only,
then re-run using all settings at the end.
...
# Showing that Chemical + Species + Route + Media + Dose defines
# A CvT experiment, not necessarily Study_ID
my_data %>% dplyr::distinct(Study_ID,
                            Chemical, Species, Route, Media, Dose)
...
system.time(my_pk <- do_fit(my_pk)) # 72 seconds, 11 data_groups
