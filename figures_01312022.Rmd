...
write.csv(PK.fit.table.1comp[[1]], "inst/ext/PK.fit.table.1comp.05092022.csv", row.names = FALSE)
write.csv(PK.fit.table.1comp[[2]], "inst/ext/processed.1comp.data.05092022.csv", row.names = FALSE)

write.csv(PK.fit.table.2comp[[1]], "inst/ext/PK.fit.table.2comp.05092022.csv", row.names = FALSE)
write.csv(PK.fit.table.2comp[[2]], "inst/ext/processed.2comp.data.05092022.csv", row.names = FALSE)

write.csv(PK.fit.table.flat[[1]], "inst/ext/PK.fit.table.flat.05092022.csv", row.names = FALSE)
write.csv(PK.fit.table.flat[[2]], "inst/ext/processed.flat.data.05092022.csv", row.names = FALSE)
```
