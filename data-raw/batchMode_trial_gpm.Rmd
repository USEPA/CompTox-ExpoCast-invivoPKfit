...
# Write into package
evaluate_choices <- function(obj) {
  pk_name <- get_choices(obj)
...
my_pk_101p <- do_fit(my_pk_101p) %>% evaluate_choices()
...
# Run all at once
{
current_pk <- my_pk_101p # Define current evaluated pk object here
