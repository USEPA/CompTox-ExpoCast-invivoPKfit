...
You can get the predicted values (for the time points, doses, and routes in the original data) using `predict()`

```{r}
predict(my_pk)
```

If instead you want to get predicted values for new data, you can do this by providing argument `newdata`
