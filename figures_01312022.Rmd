...
### subset to only actual model outputs and discard "Joint Analysis" rows
pk_data2 <- pk_output_2comp_02102022 %>%
  filter(param.value.type == "Fitted geometric mean" & Data.Analyzed != "Joint Analysis")

raw_data2 <- dplyr::select(raw_2comp_02102022, -c("kelim", 
                                                  "Vdist", 
                                                  "Fgutabs", 
                                                  "kgutabs",
                                                  "V1",
...
data2 <- as.data.table(pk_output_2comp_02102022 %>%
                         filter(param.value.type == "Fitted geometric mean"))
...
# write.csv(fittable, file = "inst/ext/model_params_table.csv", row.names = FALSE)
...
pk_data2 <- as.data.table(pk_output_2comp_02102022)
...
pk_data_flat <- pk_output_flat_02102022 %>%
