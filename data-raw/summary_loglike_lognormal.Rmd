...
samp[c("est_sample_meanlog",
       "est_sample_sdlog")] <- convert_summary_to_log(sample_mean = samp$sample_mean,
...
Log-scale sample SD. The "true" population log-scale SD (1.0) is indicated by vertical and horizontal dashed lines.
...
The estimated log-scale sample SD usually underestimates the actual log-scale sample SD (most points are below the identity line).
