...
load("data-raw/RCdata/chem_lists.RData")
load("data-raw/plasma_CvTfits_data.RData")
load("data-raw/RCdata/rat_pars_human.RData")
load("data-raw/RCdata/rat_pars_rat.RData")
...
interspecies_rmsle_trends <- bind_rows(rpr_rmsle, rph_rmsle) %>%
  ...
  group_by(Chemical, close_clint, clearance_type) %>%
...
species_clint_pl + interspecies_rmsle_trends +
...
Next what we want to do is get httk predictions for nonrestrictive & 
restrictive chemicals, but going from 
